...
<div style="padding:16px 16px 0">
  ...
  <!-- MARKET DATA -->
  <div class="card">
    <div style="font-size:11px;color:#888;margin-bottom:12px;font-weight:600;letter-spacing:.1em">&#128202; נתוני שוק &mdash; {generated_at}</div>
  ...
  <div id="sell-wrap" class="section-card">
    ...
    <div style="padding:14px 18px;border-top:1px solid #f0f0f0;background:#fafafa">
      ...
      {f'<div class="order-row" style="border:1px solid #fca5a5"><div><div style="font-size:12px;font-weight:600;color:#333;margin-bottom:3px">Limit Sell — 212 מניות (50%)</div><div style="font-size:11px;color:#888">+4% מהפתיחה | רווח משוער: ${profit4:.0f}</div></div><div style="font-size:18px;font-weight:800;font-family:monospace;color:#dc2626">${t4}</div></div>'}
      {f'<div class="order-row" style="border:1px solid #fca5a5"><div><div style="font-size:12px;font-weight:600;color:#333;margin-bottom:3px">Limit Sell — 106 מניות (25%)</div><div style="font-size:11px;color:#888">+6% מהפתיחה | רווח משוער: ${profit6:.0f}</div></div><div style="font-size:18px;font-weight:800;font-family:monospace;color:#ef4444">${t6}</div></div>'}
    </div>
  </div>
  ...
  <div id="rebuy-wrap" class="section-card">
    ...
    <div style="padding:14px 18px;border-top:1px solid #f0f0f0;background:#fafafa">
      <div style="font-size:11px;font-weight:700;color:#888;margin-bottom:10px">&#128203; פקודות Limit מוצעות</div>
      {f'<div class="order-row" style="border:1px solid #86efac"><div><div style="font-size:12px;font-weight:600;color:#333;margin-bottom:3px">Limit Buy אגרסיבי (תוך-יומי)</div><div style="font-size:11px;color:#888">2% מתחת למחיר | +{extra} מניות בונוס</div></div><div style="font-size:18px;font-weight:800;font-family:monospace;color:#16a34a">${rb1}</div></div>'}
      {f'<div class="order-row" style="border:1px solid #86efac"><div><div style="font-size:12px;font-weight:600;color:#333;margin-bottom:3px">Limit Buy מאוזן (תוך-יומי)</div><div style="font-size:11px;color:#888">1.5% מתחת | איזון בין מחיר למילוי</div></div><div style="font-size:18px;font-weight:800;font-family:monospace;color:#22c55e">${rb15}</div></div>'}
      {f'<div class="order-row" style="border:1px solid #86efac"><div><div style="font-size:12px;font-weight:600;color:#333;margin-bottom:3px">Limit Buy שמרני (יום המחרת)</div><div style="font-size:11px;color:#888">3% מתחת | סיכוי מילוי נמוך אך מחיר טוב</div></div><div style="font-size:18px;font-weight:800;font-family:monospace;color:#4ade80">${rb2}</div></div>'}
    </div>
  </div>
